...
const VaddiList = ({ navigateTo }) => {
  ...
  const generateAcknowledgmentPDF = (entry, shouldPrint = false) => {
    ...
    doc.setFontSize(14);
    doc.text('RaviShankar Tracker', 105, 28, { align: 'center' });
    doc.setFontSize(10);
    ...
    doc.setFontSize(10);
    const mainText = `Naan, ${entry.name}, Santhosh Kumar (RaviShankar Tracker) avarkalitam irunthu kadan petrathai oppukolkiren.`;
    const mainTextEn = `I, ${entry.name}, hereby acknowledge receiving a loan from Santhosh Kumar (RaviShankar Tracker).`;
...
- RaviShankar Tracker`;
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(20);
    doc.setFont('helvetica', 'bold');
    doc.text('RaviShankar Tracker', 105, 15, { align: 'center' });
    doc.setFontSize(14);
