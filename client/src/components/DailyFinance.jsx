  ...
  const printReceiptFallback = (customer, loan, payment) => {
    ...
    printWindow.document.write(`
      <html>
        ...
        <body>
          <div class="center bold" style="font-size: 16px;">RS Tracker</div>
          ...
          <div class="center">RS Tracker</div>
        </body>
      </html>
    `);
...
- RaviShankar Tracker`;
  ...
  const sendWhatsAppReminder = (phone, name, amount, dayNumber) => {
    const message = `Hi ${name}, your daily payment of ${formatCurrency(amount)} (Day ${dayNumber}/100) is due today. Please pay. - RS Tracker`;
